// app.js — Firebase + fotos via Apps Script + filtros/ordenação + máscara chip + busca estilizada
...
function renderBuscaResultado(data){
  ...
  box.innerHTML = `
    ...
    <div class="result-grid">
      <div class="kv"><label>Data de fabricação</label><div>${fmtBRDateStr(data.dataFabricacao)}</div></div>
      ...
      <div class="kv"><label>Número do chip</label><div>${data.numeroChip||'-'}</div></div>
...
function initApp(){
  ...
  // Enter no campo também consulta
